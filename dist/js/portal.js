...
let layoutTemplates = [
    ...
    {name:"funny", page: "funny", desc: "", code: ["Dadjokes", "NineGag", "Todo|col-sm-4", "BoredPanda|col-sm-12", ,"Buzzfeed", "Epic", "GIFY|col-sm-4", "PhotoNatgeo",]},
];
            ...
            window[title].state.currentData.forEach(function (el, idx) {
                ...
                if (zeroIndex >= start && zeroIndex < stop) {
                   ...
                   var temp = `<span class='rss_image_wrap'>
                        <img class='rss_image' src='${el.image}' alt='rss item featured' />
                    </span>
